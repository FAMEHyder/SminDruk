...
import {
  ...
  FaTiktok, FaPinterest, FaMapMarkerAlt, FaTwitter,
} from "react-icons/fa";
...
export default function DashboardPage() {
  ...
  // 🔴 hard guard (no user = no dashboard actions)
  if (!userId) {
    return (
  ...
  const menuItems = [
    {
      ...
      action: () => {
        window.location.href = `https://sat-tara-backend.vercel.app/api/auth/facebook?userId=${userId}`;
      },
    },
    {
